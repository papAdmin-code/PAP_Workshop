          ...
          <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <div class="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
              <div>
                ...
                <h2 class="mt-3 text-xl font-bold text-gray-900 dark:text-white sm:text-2xl">Electronics</h2>
              </div>
              ...
              <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <div class="pt-6">
                  ...
                  <div class="mt-4 flex items-center justify-between gap-4">
                    ...
                    <button type="button" onClick={this.handleClick} class="inline-flex items-center rounded-lg bg-blue-300 px-5 py-2.5 text-sm font-medium text-black hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 ">
